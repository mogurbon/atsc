...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    save: function save() {
      return this.axios.post('/movies', this.movie).then(function (response) {
...
(0,vee_validate__WEBPACK_IMPORTED_MODULE_2__.localize)('es', vee_validate_dist_locale_es_json__WEBPACK_IMPORTED_MODULE_3__);
/**
